...
a reasonable problem to deal with. It's mainly separating concerns in emacs
configs while being able to quickly edit the config. The benefits and drawbacks
to the process and potentiallys are probably similar to Literate dotfiles --
they can provide a standard experience or make projects like ESS/Scimacs/Doom
more consistent or replicable.
