...
Update with a script like this

#+headers: :var emacsg_manifest=(expand-file-name "emacs-g.scm" dc/emacs-d)
#+headers: :var guix_manifest_dir=(expand-file-name "guix/manifests" (getenv "XDG_CONFIG_HOME"))
#+headers: :tangle (expand-file-name ".bin/update-emacs-g" (getenv "HOME")) :tangle-mode (identity #o744)
#+begin_src sh
manifest=$emacsg_manifest
guix_manifests=$guix_manifest_dir
cp $manifest $guix_manifest_dir
