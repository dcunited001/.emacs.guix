...
;;
;; Copyright © 2016-2023 John Kitchin
;;
;; All code in scimax is licenced under the Creative Commons
;; Attribution-ShareAlike 4.0 International license where allowed. See
;; https://creativecommons.org/licenses/by-sa/4.0/legalcode
;;
;; Where required the Gnu Public License is used
;; (https://www.gnu.org/licenses/gpl-3.0.en.html).


;; From Scimax:

;; https://github.com/jkitchin/scimax/blob/master/emacs-keybinding-command-tooltip-mode.el
